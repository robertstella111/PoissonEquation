...
private:
  ...
  double (*dirichlet)(double, double,
                      double); // R�ckgabe sind die Dirichlet Randwertbedinungen
  double (*neumannx)(double, double,
                     double); // Ableitung des Potentials nach x, Paramter y
  double (*neumanny)(double, double,
                     double); // Ableitung des Potentials nach y, Paramter x
...
public:
  ...
  ThreeD(long N1, long N2, long N3, double a, double b, double c, double d,
         double e, double f, double (*fun)(double, double, double),
